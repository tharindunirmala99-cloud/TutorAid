...
export const TUTORS: Tutor[] = [
  ...
  },
  {
    id: '2',
    name: 'Amavi',
    subject: 'Maths & Science Tutor',
    rating: 5.0,
    bio: 'Undergraduate from Sabaragamuwa University of Sri Lanka, with multiple years of teaching experience',
  ...
  },
  {
    id: '4',
    name: 'Tharindu',
    subject: 'Mathematics/Science/ICT Tutor',
    rating: 4.0,
    bio: '3 Years + experience in tutoring for students across multiple countries',
    tags: ['Maths', 'Science', 'ICT'],
    imageUrl: '',
  ...
  },
  {
    ...
    subject: 'Mathematics Tutor',
    rating: 5.0,
    bio: 'Undergraduate at University of Kelaniya. I provide interactive one-on-one Mathematics lessons for primary and secondary students, focusing on bridging learning gaps.',
    tags: ['Mathematics'],
    imageUrl: '',
    gradient: 'from-cyan-200 to-blue-200'
  }
...
export const TESTIMONIALS: Testimonial[] = [
  ...
  {
    id: '2',
    name: 'Mrs. Senevirathna',
    role: 'Parent of 9th Grader',
    content: '"The tutors here are amazing. They explain things in a way that actually makes sense.My son used to hate science, but now it\'s his favorite subject."',
